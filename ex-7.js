...
// Start coding here
let isArray = Array.isArray(orders); //1
let creditCardTypeOfBlindermann = orders[2].creditCardType; //2
orders[2].creditCardType = "visa"; //3
let productQuantityOfJoannet = orders[3].productQuantityOfJoannet;
